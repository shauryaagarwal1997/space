...
display(){
    ...
    butEar.mousePressed(()=>{
        ...
        earPlanet=createSprite(displayWidth/2-550,displayHeight/2,10,10);
        ...
        text("6. Radius : ",displayWidth/2-90,displayHeight/2+75)
        text("7. Escape Velocity : ",displayWidth/2-90,displayHeight/2+125)
        text("8. Nickname : ",displayWidth/2-90,displayHeight/2+175)
        fill("blue");
        text("1 AU (152 million km)",displayWidth/2+390,displayHeight/2-175);
        fill("purple");
        text("24 hours",displayWidth/2+160,displayHeight/2-125);
        fill("blue");
        text("365 days",displayWidth/2+160,displayHeight/2-75);
        fill("purple");
        text("Rocky / terrestrial",displayWidth/2+130,displayHeight/2-25);
        fill("blue");
        text("1 (one)",displayWidth/2+210,displayHeight/2+25);
        fill("blue");
        text("6371 km",displayWidth/2+60,displayHeight/2+75);
        fill("purple");
        text("11.2 km/s",displayWidth/2+180,displayHeight/2+125);
        fill("blue");
        text("The Blue Planet",displayWidth/2+100,displayHeight/2+175);
     })
